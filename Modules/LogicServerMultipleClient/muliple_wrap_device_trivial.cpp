...
STDMETHODIMP WrapperDirect3DDevice9::Present(THIS_ CONST RECT* pSourceRect, CONST RECT* pDestRect, HWND hDestWindowOverride, CONST RGNDATA* pDirtyRegion) {
	...
	Log::log("WrapperDirect3DDevice9::Present() frame time:%d\n", elapse_time);
	...
	if (elapse_time >= 1000.0) {
		...
		frame_cnt = 0;
		elapse_time = 0;
		Log::log("WrapperDirect3DDevice9::Present(), exp=%d fps=%.3f latency average:%.3f \n", cs.config_->max_fps_, fps, time_total / frame_all_count);
	}
#endif
	/////////////////////////////////////////////////////////////////////
	cs.end_command();
